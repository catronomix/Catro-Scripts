...
class Colors:
	...
	BG_BLUE = '\033[48;2;0;0;255m' # Blue
...
def resize_images_in_folder():
	...
	# Check for images BEFORE asking for parameters or creating folders
	...
	# Create output directory only now that we are ready to process
